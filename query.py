...
class QueryDialog(QtGui.QDialog, Ui_QueryDialog):
    def __init__(self, parent=None):
        ...
        if not hasattr(sys, "frozen"):
            self.links_te.setPlainText('http://zipta.ru/sitemap.xml\nhttp://blap.ru/sitemap.xml\nhttp://www.dns-shop.ru/sitemap.xml')
    ...
    def accept(self):
        if self.get_links():
            ...
            QtGui.QMessageBox.information(self, u'Парсинг', u'Укажите список карт для обработки.')
